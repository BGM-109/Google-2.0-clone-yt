    ...
    <div className="flex flex-col items-center justify-center h-screen" > 
      ...
      <form className="flex flex-col mt-44 items-center flex-grow w-4/5"> 
        <Image
          ...
          height={100}
        />
        <div className="flex w-full max-w-md mt-5 rounded-full border border-gray-200 hover:shadow-lg focus-within:shadow-lg px-5 py-3 items-center sm:max-w-xl lg:max-w-2xl">
